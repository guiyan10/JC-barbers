        ...
        <tr>
            <td style="padding: 24px;">
                ...
                <p style="margin: 0 0 16px; color: #374151;">
                    Ola, <?php echo e($agendamento->cliente->nome); ?>! Seu horario foi agendado com sucesso na JC Barber.
                </p>

                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                    <tr>
                        <td style="padding: 8px 0; color: #6b7280; width: 180px;">Servico</td>
                        <td style="padding: 8px 0; color: #111827;"><strong><?php echo e($agendamento->servico->nome); ?></strong></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; color: #6b7280;">Data e horario</td>
                        <td style="padding: 8px 0; color: #111827;"><strong><?php echo e(\Carbon\Carbon::parse($agendamento->data_hora)->format('d/m/Y \a\s H:i')); ?></strong></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; color: #6b7280;">Telefone</td>
                        <td style="padding: 8px 0; color: #111827;"><?php echo e($agendamento->cliente->telefone); ?></td>
                    </tr>
                </table>
...
<?php /**PATH C:\Users\guiya\OneDrive\Área de Trabalho\Projetos\JC barbers\resources\views/emails/agendamento-confirmado.blade.php ENDPATH**/ ?>